...
import '../tdapi/tdapi.dart' show TdObject, TdFunction, convertToObject;
import 'dart:convert' show json;

class TdClient {
  static const _platform = MethodChannel('telegram_service_call');
  static const EventChannel _eventChannel =
      EventChannel('telegram_service_event');
